...
eval_both = pd.read_excel('./evaluation_S276/evaluate_both.xlsx')
eval_forward = pd.read_excel('./evaluation_S276/evaluate_forward.xlsx')
eval_reverse = pd.read_excel('./evaluation_S276/evaluate_reverse.xlsx')
...
res.append(float(eval_forward.loc[eval_forward.iloc[:,0]=='rmse']['prediction_on_S276_forward']))
res.append(float(eval_forward.loc[eval_forward.iloc[:,0]=='pearson']['prediction_on_S276_forward']))


res.append(float(eval_reverse.loc[eval_reverse.iloc[:,0]=='rmse']['prediction_on_S276_reverse']))
res.append(float(eval_reverse.loc[eval_reverse.iloc[:,0]=='pearson']['prediction_on_S276_reverse']))



pred_ddg_forward=list(pd.read_excel('./evaluation_S276/pred_ddg_forward.xlsx')['pred_ddg'])
pred_ddg_reverse=list(pd.read_excel('./evaluation_S276/pred_ddg_reverse.xlsx')['pred_ddg'])
...
forward_true_ddg=read_xls_ddg('./data/raw_data/S276_forward_raw.xls')
reverse_true_ddg=read_xls_ddg('./data/raw_data/S276_reverse_raw.xls')
...
for i in range(len(res)):
    ws.write(1,i,res[i])
wb.save('./evaluation_S276/evaluation_summary.xls')
