...
data_train = pd.read_csv("./data/feature_data/Q3421_fea_table_double.csv")  # 读取数据
data_test = pd.read_csv("./data/feature_data/p53_fea_table_single.csv")
...
# average
# 均方根误差（RMSE）: 1.7315870851514372
# 皮尔逊相关系数（pearson）: 0.2803240130869945
