...
data = pd.read_csv("./data/feature_data/S2648_fea_table_double.csv")  # 读取数据
...
# average
# 均方误差（MSE）: 0.9177969784490576
# 均方根误差（RMSE）: 0.9575888749625131
# 平均绝对误差（MAE）: 0.7089724991500361
# 决定系数（R^2 Score）: 0.7110197142169136
# 皮尔逊相关系数（pearson）: 0.8446763085467758
# 斯皮尔曼相关系数（spearman）: 0.8457248629765843
