...
data_train = pd.read_csv("./data/feature_data/S2648_fea_table_double.csv")  # 读取数据
data_test = pd.read_csv("./data/feature_data/Q306_fea_table_single.csv")
...
# average
# 均方根误差（RMSE）: 1.9005720919597537
# 皮尔逊相关系数（pearson）: 0.32268320259344396
