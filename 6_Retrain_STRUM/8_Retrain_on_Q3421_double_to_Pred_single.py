...
data_single = pd.read_csv("./data/feature_data/Q3421_fea_table_single.csv")  # 读取数据
data_double = pd.read_csv("./data/feature_data/Q3421_fea_table_double.csv")  # 读取数据
...
# RMSE: 1.2473035629572657
# pearson: 0.7784969175660954
