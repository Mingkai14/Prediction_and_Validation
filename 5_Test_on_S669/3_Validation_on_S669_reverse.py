...
data = pd.read_csv("./data/feature_data/S669_fea_table_reverse.csv")  # 读取数据
...
pred_ddg_both.to_excel("./evaluation_S669/pred_ddg_reverse.xlsx", index=True)
...
evaluate_result = pd.DataFrame(
    ...
    columns=['prediction_on_S669_reverse'],
)

evaluate_result.to_excel("./evaluation_S669/evaluate_reverse.xlsx", index=True)  # 保存评估结果
