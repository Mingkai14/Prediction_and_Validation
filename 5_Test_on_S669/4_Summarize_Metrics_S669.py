...
eval_both = pd.read_excel('./evaluation_S669/evaluate_both.xlsx')
eval_forward = pd.read_excel('./evaluation_S669/evaluate_forward.xlsx')
eval_reverse = pd.read_excel('./evaluation_S669/evaluate_reverse.xlsx')
...
res=[]
res.append(float(eval_both.loc[eval_both.iloc[:,0]=='pearson']['prediction_on_S669_both']))
res.append(float(eval_both.loc[eval_both.iloc[:,0]=='rmse']['prediction_on_S669_both']))
res.append(float(eval_both.loc[eval_both.iloc[:,0]=='mae']['prediction_on_S669_both']))

res.append(float(eval_forward.loc[eval_forward.iloc[:,0]=='pearson']['prediction_on_S669_forward']))
res.append(float(eval_forward.loc[eval_forward.iloc[:,0]=='rmse']['prediction_on_S669_forward']))
res.append(float(eval_forward.loc[eval_forward.iloc[:,0]=='mae']['prediction_on_S669_forward']))

res.append(float(eval_reverse.loc[eval_reverse.iloc[:,0]=='pearson']['prediction_on_S669_reverse']))
res.append(float(eval_reverse.loc[eval_reverse.iloc[:,0]=='rmse']['prediction_on_S669_reverse']))
res.append(float(eval_reverse.loc[eval_reverse.iloc[:,0]=='mae']['prediction_on_S669_reverse']))



pred_ddg_forward=list(pd.read_excel('./evaluation_S669/pred_ddg_forward.xlsx')['pred_ddg'])
pred_ddg_reverse=list(pd.read_excel('./evaluation_S669/pred_ddg_reverse.xlsx')['pred_ddg'])
...
forward_true_ddg,reverse_true_ddg=read_xls_ddg('./data/raw_data/S669_raw.xls')
...
for i in range(len(res)):
    ws.write(1,i,res[i])
wb.save('./evaluation_S669/evaluation_summary.xls')
